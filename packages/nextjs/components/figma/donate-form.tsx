...
const DonateForm: NextPage = () => {
  ...
  return (
    <div className="w-[1279px] h-[212px] overflow-hidden shrink-0 flex flex-row items-center justify-start gap-[100px] text-center text-16xl text-studio-darkmode-allwhite-ffffff font-inconsolata">
      <TextField
