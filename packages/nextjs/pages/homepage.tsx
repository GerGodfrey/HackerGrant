...
const Homepage: NextPage = () => {
  ...
  return (
    <div className="relative bg-studio-darkmode-allwhite-ffffff w-full overflow-hidden flex flex-col items-center justify-start text-center text-[100px] text-studio-darkmode-allwhite-ffffff font-mono hover:[background:linear-gradient(#fff,_#fff),_#87550a] sm:w-full sm:hover:bg-orange-300">
